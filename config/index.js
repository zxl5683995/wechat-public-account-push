export const USER_CONFIG = {
  ...
  // 公众号APP_ID
  // 建议不要填这里，请使用文档中github secret的方法
  ...
  USERS: [
    {
      ...
      id: "o1hEg5mQ6qE2T217UAQkpcSGsW68",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "w73-Db6BYNcGwt5glGdfDJFjoNcLF3kcOwpUj7HAQGQ",
      // 所在省份
      province: "河南",
      // 所在城市
      city: "郑州",
      ...
      festivals: [
        ...
        {"type": "*生日", "露露": "老婆", "year": "2003", "date": "11-22"},
        {"type": "节日", "name": "结婚纪念日", "year": "2020", "date": "09-03"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "亮亮": "李四", "year": "2004", "date": "r05-18"},
        {"type": "节日", "name": "被搭讪纪念日", "year": "2021", "date": "09-01"},
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2022-06-22"},
        // 结婚纪念日
